...
The culminating project of Saint Mary's four-part MAIT-600 sequence, I was fortunate to find an an answer out of an initial four questions spread evenly between Mathematical Knowledge and Pedagogy, and to know the differences between them. To then find a very recent extension of Pedagogical Content Knowledge in Mathematics (PCK) that focuses on a rehumanization through Social-Emotional Learning (SEL) excited me to no limit.
